...
:: 0 --------------------
:0 
title Automatic Shutdown Program V5 - Cancel command - Created by: Levminer
cls
shutdown -a 
cls
...
:: 1 --------------------
:1
title Automatic Shutdown Program V5 - Shutdown after a given time (seconds) - Created by: Levminer
cls
echo (9) Back
echo.
...
:: 2 --------------------
:2
title Automatic Shutdown Program V5 - Shutdown after a given time (minutes) - Created by: Levminer
cls
echo (9) Back
echo.
...
:: 3 --------------------
title Automatic Shutdown Program V5 - Shutdown after a given time (hours) - Created by: Levminer
:3
cls
echo (9) Back
echo.
...
:: 4 --------------------
:4
title Automatic Shutdown Program V5 - Restart after a given time (seconds) - Created by: Levminer
cls
echo (9) Back
echo.
set /p "l=Enter the value in seconds! (0-9) % %"
...
:: 5 --------------------
:5
title Automatic Shutdown Program V5 - Restart after a given time (minutes) - Created by: Levminer
cls
echo (9) Back
echo.
set /p "l=Enter the value in minutes! (0-9) % %"
...
:: 6 --------------------
title Automatic Shutdown Program V5 - Restart after a given time (hours) - Created by: Levminer
:6
cls
echo (9) Back
echo.
...
:: 7 --------------------
:7
title Automatic Shutdown Program V5 - Settings - Created by: Levminer
cls
echo (9) Back
echo.
echo (1) Red
...
echo (3) Green
echo.
set /p color="Press the correct button! (0-9) % %"
if %color%==1 goto 7.1
if %color%==2 goto 7.2
if %color%==3 goto 7.3
...
:: 8 --------------------
:8
title Automatic Shutdown Program V5 - About - Created by: Levminer
cls
echo (9) Back
echo.
echo Automatic Shutdown Program V5
